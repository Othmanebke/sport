...
const allSports = [
  ...
  { id: 'tennis',      name: 'TENNIS',      image: 'https://images.unsplash.com/photo-1560012057-4372e14c5085?w=1200&q=80',      tagline: 'MAÎTRISE CHAQUE COUP',      cat: 'Individuel' },
  ...
  { id: 'karate',      name: 'KARATÉ',      image: 'https://images.unsplash.com/photo-1530417838433-4b24dd3f72d4?w=1200&q=80',   tagline: 'MAÎTRISE & DISCIPLINE',     cat: 'Combat' },
  ...
  { id: 'golf',        name: 'GOLF',        image: 'https://images.unsplash.com/photo-1535131749006-b7f58c99034b?w=1200&q=80',   tagline: 'PRÉCISION ET ÉLÉGANCE',     cat: 'Individuel' },
  { id: 'randonnee',   name: 'RANDONNÉE',   image: 'https://images.unsplash.com/photo-1501555088652-021faa106b9b?w=1200&q=80',   tagline: 'EXPLORE LA NATURE',         cat: 'Nature' },
  { id: 'accrobranche',name: 'ACCROBRANCHE',image: 'https://images.unsplash.com/photo-1561063206-c8fc36bac012?w=1200&q=80',     tagline: 'DÉFI EN HAUTEUR',           cat: 'Nature' },
...
export default function SportsGuidePage() {
  ...
  return (
    <div className="min-h-screen bg-[#080e0a] text-white">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
            <div>
              ...
              <h1 className="text-7xl md:text-[10rem] font-black leading-none uppercase text-white">
                GUIDE<br/>
                <span style={{ WebkitTextStroke: '2px #406b4a', color: 'transparent' }}>SPORT.</span>
              </h1>
            </div>
            {/* Search */}
            <div className="relative max-w-sm w-full mb-2">
              ...
              <input
                ...
                className="w-full pl-7 pr-4 py-3 bg-transparent border-b border-white/15 text-white placeholder-white/20 focus:outline-none focus:border-[#406b4a] transition-colors text-sm"
              />
            </div>
          </div>
        </div>
      ...
      {/* ── FILTERS ── */}
      <div className="sticky top-[72px] z-30 bg-[#080e0a] border-b border-white/5 px-4 md:px-12">
      ...
      <section className="px-4 md:px-12 py-12 max-w-[1200px] mx-auto">
        {filtered.length === 0 ? (
          <div className="text-center py-24">
            <p className="text-white/20 text-6xl font-black uppercase">AUCUN<br/>RÉSULTAT</p>
          </div>
        ) : (
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-px bg-white/5">
            {filtered.map((sport, idx) => (
              <motion.button
                ...
                className="group relative aspect-[4/3] overflow-hidden bg-[#0d1a10] text-left"
              >
                {/* Image */}
                <img
                  src={sport.image}
                ...
                <div className="absolute bottom-0 left-0 right-0 p-5">
                  {/* Green accent line */}
                  <div className="w-6 h-0.5 bg-[#406b4a] mb-3 group-hover:w-12 transition-all duration-300" />
